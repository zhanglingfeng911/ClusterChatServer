...
int main(int argc, char *argv[])
{
    ...
    for (;;)
    {
        ...
        case 1: //1. 登陆
        {
            ...
            cin.get();
            cout << "password:";
            cin.getline(pwd, 50); //cin.getline()避免遇见空格就停止 例如zhang ling feng
            ...
            else
            {
                ...
                { //success:responsejs{msgid errno id name}
                    ...
                    else //登陆成功
                    {
                        ...
                        //显示登陆用户的基本信息
                        showCurrentUserData(); //zlf:上面存储了vector<User>g_currentUserFriendList; 和vector<Group>g_currentUserGroupList;
